  ...
  return (
    ...
    {isMobile ? 
      ...
      <div className="bg-slate-900 z-50 w-screen h-[110px] flex space-x-2  items-center justify-end fixed top-0">
        ...
        <div onClick={handleChangeLang} className="text-white text-xl cursor-pointer">
          {isLangBG ? <img className="w-[30px] h-[30px] hover:brightness-50" src="/assets/misc/united-kingdom.png"/> : <img className="w-[34px] h-[34px] hover:brightness-50" src="/assets/misc/bulgaria.png"/>}
        </div>
